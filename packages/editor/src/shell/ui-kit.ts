...
export const DIALOG_BTN_PRIMARY =
  "px-3 py-1.5 bg-[#0070e0] hover:bg-[#005bb5] border border-[#0070e0] rounded text-white transition-colors disabled:opacity-40";
export const DIALOG_BTN_DANGER =
  "px-3 py-1.5 bg-[#b91c1c] hover:bg-[#dc2626] border border-[#b91c1c] rounded text-white transition-colors disabled:opacity-40";
